...
public class Study01 {
	...
	static ImageIcon bumImg, siniImg, gabiImg, bgd;
	...
	public static void main(String[] args) {
		...
		frm.setResizable(false); // 프레임 크기조절 막음.
	...
	public static void battle(Slime s) {
		...
		if (randomNum == 0) {
			...
			// 대상 몬스터를 우측으로 50만큼 이동시킨다.
			targetSlime.setBounds(targetSlime.getX() + 50, 200, 150, 150);
